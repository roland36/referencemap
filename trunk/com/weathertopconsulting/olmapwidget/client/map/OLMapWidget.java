...
import com.weathertopconsulting.olmapwidget.client.openlayers.DrawSingleFeature;
import com.weathertopconsulting.olmapwidget.client.openlayers.DrawSingleFeatureOptions;
...
public class OLMapWidget extends Composite {
	...
	public native void activateNativeHooks()/*-{
        ...
        $wnd.getMapZoom = function() {
        	var zm = localMap.@com.weathertopconsulting.olmapwidget.client.map.OLMapWidget::getZoom()();
        	return zm;
        }
        $wnd.getMapXhi = function() {
        	var p = localMap.@com.weathertopconsulting.olmapwidget.client.map.OLMapWidget::getXhi()();
        	return p;
        }
        $wnd.getMapXlo = function() {
        	var p = localMap.@com.weathertopconsulting.olmapwidget.client.map.OLMapWidget::getXlo()();
        	return p;
        }
        $wnd.getMapYhi = function() {
        	var p = localMap.@com.weathertopconsulting.olmapwidget.client.map.OLMapWidget::getYhi()();
        	return p;
        }
        $wnd.getMapYlo = function() {
        	var p = localMap.@com.weathertopconsulting.olmapwidget.client.map.OLMapWidget::getYlo()();
        	return p;
        }
        $wnd.isFeatureEditing = function() {
        	var p = localMap.@com.weathertopconsulting.olmapwidget.client.map.OLMapWidget::isEditing()();
        	return p;
        }
        $wnd.zoomAndPanToSelection = function() {
        	localMap.@com.weathertopconsulting.olmapwidget.client.map.OLMapWidget::zoomMapToSelection()();
        }
